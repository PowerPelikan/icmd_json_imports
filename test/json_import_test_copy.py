...
if __name__ == '__main__':
    ...
    print(data1.is_datakey("phase_fraction"))
    print(data1.is_datakey("phase"))

    data2 = json_import.IcmdData('test/testfiles/tesla_tempStep_solidif.json')
    print(data2.get_datakeys_of_models())
    print(data2.get_datakeys_of_models())
    print(data2.is_datakey("phase_fraction"))
    print(data2.is_datakey("phase"))
    print(data2.is_datakey("phase_fraction", "Solidification"))
